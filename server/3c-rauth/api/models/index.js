...
//var pDB                =  dbConnect( 'FORMR' );                                           //#.(10220.10.1 RAM Switch to db.connect).(10328.0x.x).(10414.02.2).(10928.01.1).(10928.02.3)
  var pDB                =  dbConnect( 'RAUTH', 'checkDB' );                                // .(10220.10.1 RAM Switch to db.connect).(10328.0x.x).(10414.02.2).(10928.01.1 RAM Change DB Reference).(10928.02.3 RAM add 'checkDB')
